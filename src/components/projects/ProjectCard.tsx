...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
	...
	return (
		<div
			ref={ref}
			className="flex flex-col items-center justify-between p-4 w-full rounded-lg bg-dark-blue text-white hover:-translate-y-1 transition duration-300 ease-in-out"
		>
